...
function normalizeProject(repo, metadata = {}, progress = {}, languages = {}) {
	...
	return {
		...
		done: normalizeList(progress.done ?? progress.completed ?? metadata.done, [
...
async function main() {
	try {
		...
		for (const repo of repos) {
			...
			projects.push(normalizeProject(repo, metadata || {}, progress || {}, languages));
		}
